...
public class GuiCellAnalyser extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation(Reference.MODID, "textures/gui/guicellanalyser.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		fontRenderer.drawString("Cell Analyser", LABEL_XPOS, LABEL_YPOS, Color.darkGray.getRGB());

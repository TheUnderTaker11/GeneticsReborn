...
public class CloningMachine extends StorageBlockBase{
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tile!=null&&tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.UP)!=null&&tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.DOWN)!=null
        	&&tile instanceof GRTileEntityCloningMachine&&tile.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.UP))
        {
        	GRTileEntityCloningMachine tileentity = (GRTileEntityCloningMachine)tile;

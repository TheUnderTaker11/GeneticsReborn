...
public class PlasmidInjector extends StorageBlockBase{
    ...
    {
		return new GRTileEntityPlasmidInjector();
    }
	@Override
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if(tEntity!=null&&tEntity instanceof GRTileEntityPlasmidInjector&&hand==EnumHand.MAIN_HAND)
		{
			...
			else playerIn.openGui(GeneticsReborn.instance, GuiHandler.PlasmidInjectorGuiID, worldIn, pos.getX(), pos.getY(), pos.getZ()); 
		}
		return true;
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tile!=null&&tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.UP)!=null&&tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.DOWN)!=null
        	&&tile instanceof GRTileEntityPlasmidInjector&&tile.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.UP))
        {
        	GRTileEntityPlasmidInjector tileentity = (GRTileEntityPlasmidInjector)tile;

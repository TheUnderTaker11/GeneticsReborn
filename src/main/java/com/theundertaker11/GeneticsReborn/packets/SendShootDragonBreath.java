	            ...
	            public void run() {
	            	...
	            	if(GeneticsReborn.enableDragonsBreath&&allow&&ModUtils.getIGenes(serverPlayer)!=null)
	            	{
	            		...
	            		if(genes.hasGene(EnumGenes.DRAGONS_BREATH))
	            		{
	        	            ...
	        	            EntityDragonFireball dragonfireball = new EntityDragonFireball(serverPlayer.getEntityWorld(), serverPlayer.posX, serverPlayer.posY + serverPlayer.eyeHeight, serverPlayer.posZ, v3.x, v3.y, v3.z);
